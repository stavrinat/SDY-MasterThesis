...
emotions, polarity = sa.sentiment_analysis_process1(doc_lemmatization)
#print(emotions)


# step 5: visualize text mining data, using various techniques
visual.visualization_for_sentiment_analysis_per_emotion(emotions)
visual.visualization_for_sentiment_analysis_polarity(polarity)
